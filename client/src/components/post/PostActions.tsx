...
import { MoreHorizontal, Edit, Trash2, X, Bookmark } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export function PostActions({ post, onEditClick, onAddToListClick }: PostActionsProps) {
  const { user } = useAuth();
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-40">
          {/* Add to list option - available for all users */}
          <DropdownMenuItem 
          ...
          {/* Edit and delete options - only for post authors */}
          {isAuthor && (
            <>
              <DropdownMenuItem 
                onClick={onEditClick}
